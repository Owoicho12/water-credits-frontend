    ...
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        ...
        <button (click)="showForm = !showForm" class="btn btn-primary flex items-center gap-2">
          <lucide-icon [img]="showForm ? X : Plus" class="w-4 h-4"></lucide-icon>
          ...
          >
            <div class="flex items-start justify-between mb-3">
              <div class="flex items-center gap-2">
                <div class="w-8 h-8 rounded-lg bg-stellar-blue/10 flex items-center justify-center">
                  <lucide-icon [img]="Sprout" class="w-4 h-4 text-stellar-blue"></lucide-icon>
                </div>
            ...
            <div class="grid grid-cols-2 gap-2 text-xs">
              <div class="flex items-center gap-1">
                <lucide-icon [img]="Ruler" class="w-3 h-3 text-slate-400"></lucide-icon>
              ...
              <div class="flex items-center gap-1">
                <lucide-icon [img]="Crop" class="w-3 h-3 text-slate-400"></lucide-icon>
              ...
              <div class="flex items-center gap-1">
                <lucide-icon [img]="Globe" class="w-3 h-3 text-slate-400"></lucide-icon>
              ...
              <div class="flex items-center gap-1">
                <lucide-icon [img]="Calendar" class="w-3 h-3 text-slate-400"></lucide-icon>
